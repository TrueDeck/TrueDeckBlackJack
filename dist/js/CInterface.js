function CInterface(iMoney){
	...
	_oDisplayText2.lineWidth = 290;
        ...
        _oCurDealerCardValueText.shadow = new createjs.Shadow("#701d46", 2, 2, 1);
        ...
        var poweredByTrueDeck = createBitmap(s_oSpriteLibrary.getSprite('powered_by_truedeck'));
        poweredByTrueDeck.x = 340;
        poweredByTrueDeck.y = 400;
        poweredByTrueDeck.scaleX = 0.30;
        poweredByTrueDeck.scaleY = 0.30;

        s_oStage.addChild(poweredByTrueDeck);

        var deployedOnGoChain = createBitmap(s_oSpriteLibrary.getSprite('deployed_on_gochain'));
        deployedOnGoChain.x = 1170;
        deployedOnGoChain.y = 400;
        deployedOnGoChain.scaleX = 0.30;
        deployedOnGoChain.scaleY = 0.30;
        s_oStage.addChild(deployedOnGoChain);
